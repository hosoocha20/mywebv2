        ...
        <div className="fixed top-[2rem] px-[2rem] z-[9999] w-screen">
          <nav className="sticky top-0 flex justify-center  min-[490px]:justify-between w-full ">
            ...
            <ul className="font-semibold menu-text md:text-[1.2rem] sm:text-[1rem] text-[1rem] sm:text-right text-center flex gap-x-[0.7rem] gap-y-[0.3rem] sm:flex-col justify-items-end sm:items-end items-center">
              <li
                className={`cursor-pointer  w-fit px-[3px] relative before:absolute before:left-0 before:z-[-1]  before:h-full  before:duration-[300ms] before:delay-200 before:ease-linear before:bg-my-yellow before:rounded ${
              ...
              <li
                className={`cursor-pointer  w-fit px-[4px] relative before:absolute before:left-0 before:z-[-1]  before:h-full before:duration-[300ms] before:delay-200 before:ease-linear before:bg-my-yellow before:rounded ${
